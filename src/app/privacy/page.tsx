...
export default function PrivacyPolicyPage() {
  return (
    <main className="bg-gray-25 min-h-screen py-12 md:py-20">
      <div className="shadow-card mx-auto max-w-[800px] rounded-2xl border border-gray-100 bg-white p-8 md:p-12">
        {/* Header */}
        ...
        {/* Content */}
        <div className="text-text-secondary space-y-8 text-sm leading-relaxed md:text-base">
          <p>
          ...
          <section className="space-y-3">
            ...
            <ul className="text-text-tertiary list-inside list-disc space-y-1.5 pl-2">
          ...
          <section className="space-y-3">
            <h2 className="text-text-primary text-lg font-bold">2. 개인정보의 수집 및 이용목적</h2>
            ...
            <ul className="text-text-tertiary list-inside list-disc space-y-1.5 pl-2">
              ...
              <li>
                서비스 제공에 관한 계약 이행 및 서비스 제공에 따른 요금정산: 콘텐츠 제공, 체험 예약
                및 결제 처리
              </li>
              <li>
          ...
          <section className="space-y-3">
            <h2 className="text-text-primary text-lg font-bold">3. 개인정보의 보유 및 이용기간</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-text-primary text-lg font-bold">4. 개인정보의 파기절차 및 방법</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-text-primary text-lg font-bold">5. 이용자의 권리와 그 행사방법</h2>
            <p>
          ...
          <section className="space-y-3">
            ...
            <div className="text-text-tertiary rounded-xl border border-gray-100 bg-gray-50 p-4 text-xs md:text-sm">
              <p className="text-text-primary mb-1 font-semibold">
                개인정보 보호담당부서: DayHOP 운영팀
              </p>
